...
var dones = tryRequire( resolve( __dirname, './../lib/ndarray.native.js' ) );
var opts = {
	'skip': ( dones instanceof Error )
};
...
tape( 'the function has an arity of 4', opts, function test( t ) {
	t.strictEqual( dones.length, 4, 'has expected arity' );
	t.end();
});
